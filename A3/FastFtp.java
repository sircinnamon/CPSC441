...
public class FastFtp {
	...
	/**
	 * @param the segment add to queue, convert to a packet and send over udp
	 * @return void
	 * @throws IOException, Interrupted exception if the socket is unable to send
	 */
	...
	/**
	 * @param a segment recieved over udb
	 * @return void
	 * @throws Interrupted exception if the socket is unable to send
	 */
	public synchronized void processAck(Segment ack) throws InterruptedException
	{
		//cancel timer
		if(DEBUG){System.out.print("Process ack: ");}
		endTimer();
	 ...
	 * @param none
	 * @return void
	 * @throws IOException if the socket cannot send
	 */
	...
	/**
	 * @param name of the server to talk to, the port to talk to, the filename to send
	 * @return true if connection is established normally, false otehrwise
	 * @throws none
	 */
	...
	/**
	 * @param name of the server to talk to, the port to talk to
	 * @return void
	 * @throws none
	 * 
	...
	{
		if(DEBUG){System.out.println("Timer cancelled.");}
		timer.cancel();
	}
